...
public class GeneralFacility implements FacilityInterface {
    int facilityID;
    String facilityName;
    String details;

    public GeneralFacility(int facilityID, String facilityName, String details) {
        this.facilityID = facilityID;
        this.facilityName = facilityName;
        this.details = details;
    }

    // this sample facility outputs 100 entities a day
    @Override
    public int output() {
        return 100;
    }
